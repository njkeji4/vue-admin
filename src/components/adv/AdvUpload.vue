<template>
	<el-dialog title="上传" ref="modal" :visible.sync="modalVisible" 
		...
		<el-form-item label="适用设备组" prop="groups" :label-width='labelwidth'>
				<el-select clearable v-model="form.groupIds" multiple placeholder="请选择">
		...
		methods: {		
			...
			uploadSubmit() {
				 this.$refs.form.validate((valid) => {
					...
					this.dataParams.groups = this.form.groupIds;
					this.dataParams.expire = this.form.expireDate;
